...
if($btnCadUsuario){
	...
	$result_usuario = "INSERT INTO usuario (nome, email, usuario, senha, cpf, nasc, telefone, cep, endereco, bairro, cidade, estado, criado) VALUES (
					'" .$dados['nome']. "',
					'" .$dados['email']. "',
					'" .$dados['usuario']. "',
					'" .$dados['senha']. "',
			...
			<form method="POST" action="">
				<div class="linha">
					...
					<div class="coluna-2">
						...
						<input style="text-transform: lowercase;" type="email" name="email" minlength="2" maxlength="40" class="text" placeholder="E-mail">
					</div>
				</div>
				<div class="linha">
					<div class="coluna-2">
						
						<input style="text-transform: lowercase;" type="text" name="usuario" minlength="2" maxlength="40" class="text" placeholder="Usuario">
					</div>
					<div class="coluna-2">
				...
				<div class="linha">
					...
					<div class="coluna-2">
						...
						<input type="date" name="nasc" minlength="8" maxlength="8">
					</div>
				</div>
				<div class="linha">
					<div class="coluna-2">
				...
				<div class="linha">
					<div class="coluna-2">
						...
						<input type="text" name="endereco" minlength="2" maxlength="50" class="text" placeholder="Endereco">
					</div>
					<div class="coluna-2">
