...
<body>
	...
	<div class="corpo">        
        ...
        <div class="formulario" id="formulario">
				...
				<form method="POST" action="P_U_produto.php">
				<input type="hidden" name="id_produto" value="<?php echo $row_produto['id_produto']; ?>">
				<div class="linha">
					<div class="coluna-2">

						<select name="marca">
							<option value="<?php echo $row_produto['marca']; ?>"><?php echo $row_produto['marca']; ?></option>
					...
					<div class="coluna-2">
						...
						<input type="text" name="modelo" value="<?php echo $row_produto['modelo']; ?>" minlength="2" maxlength="40" class="text" placeholder="Modelo">
					</div>
				</div>
				<div class="linha">
					<div class="coluna-2">
					...
					<select name="tipo">
							<option value="<?php echo $row_produto['tipo']; ?>"><?php echo $row_produto['tipo']; ?></option>
					...
					<div class="coluna-2">
						...
						<input type="text" name="preco" value="<?php echo $row_produto['preco']; ?>" minlength="2" maxlength="10" class="text" placeholder="Preco">
					</div>
                </div>
				...
				<div class="linha">
					<div class="coluna-2">
						...
						<input type="number" name="estoque" value="<?php echo $row_produto['estoque']; ?>" maxlength="4" class="text" placeholder="Estoque">
					</div>
                </div>
				...
				<div class="linha">
					<div class="coluna-1">
						...
						<textarea name="descricao" minlength="2" maxlength="1000"><?php echo $row_produto['descricao']; ?></textarea>
					</div>
				</div>
